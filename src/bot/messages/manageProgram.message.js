...
exports.expiredTask = (task) => `⚠️ <b>تسک نیمه‌تمام</b> ⚠️

📝 عنوان تسک: <b>${task.title}</b>
⏰ بازه زمانی: <b>${task.start} تا ${task.end}</b>
⏳ بیش از 30 دقیقه از زمان پایان گذشته است.

📌 وضعیت این تسک به صورت خودکار روی <b>"نیمه تمام ماند 🟤"</b> تنظیم شد.
`;
//* PAST TASKS MESSAGES
